...
const std::string ALREADY_SIGNED_UP = "Error: Student already added on this course.";
const std::string ALREADY_COMPLETED = "Error: Student already completed this course.";
const std::string NOT_SIGNED_UP = "No signups found on this course.";
