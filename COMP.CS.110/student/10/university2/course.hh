...
public:
    ...
    /**
     * @brief Sign up student for the course.
     */
    void sign_up(int student_number);

    /**
     * @brief get_sign_ups
     * @return get student numbers of sign ups.
     */
    std::vector<int> get_sign_ups();
